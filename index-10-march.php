        ...
        foreach ($table->find('td') as $td) {
            ...
            if ($td->innertext != "") {
                ...
                if (isset($href)) {
                    ...
                    $keyname = $href->innertext;
                    $data[$keyname]="";
                    $keyname2 = $href->innertext;
                } else {
                    $keyname = "";
                }
                if ($keyname == "" && !isset($href)) {
                    if($data[$keyname2]==""){
                        $data[$keyname2]= $td->innertext;
                    } else {
                        $data['battery']= $td->innertext;
                    }
...
$ret = getGSMProduct('http://www.gsmarena.com/lenovo_vibe_x2-6643.php');
print_r($ret);
